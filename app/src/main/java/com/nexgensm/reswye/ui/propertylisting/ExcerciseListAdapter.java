...
import com.nexgensm.reswye.databinding.ChooseExerciseItemBinding;
import com.nexgensm.reswye.databinding.SelectedExerciseItemBinding;
import com.nexgensm.reswye.ui.lead.AddFeatureActivity;
...
public class ExcerciseListAdapter extends RecyclerView.Adapter<ExcerciseListAdapter.ProjectHolder> {
    ...
    public boolean onLongClick(View view) {
        ...
        if (layoutId == R.layout.layout_choose_exercise_item) {
            AddFeatureActivity.isFromExercise = true;
        } else {
            AddFeatureActivity.isFromExercise = false;
        }
        return true;
    }
