...
public class PropertyDetailsBuyerFragment extends Fragment {
     ...
     * @return A new instance of fragment PropertyDetailsBuyerFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        amount3 = new String[]{"$123.456", "$346,542", "$462,768", "$637,537"};
        adapterbuyer = new PropertyViewloggedAdapter_buyer(getActivity(),amount3);
