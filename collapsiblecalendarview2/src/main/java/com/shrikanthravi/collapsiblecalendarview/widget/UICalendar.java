...
public abstract class UICalendar extends LinearLayout {
    ...
    protected void init(Context context) {
        ...
        //expandIconView       = rootView.findViewById(R.id.expandIcon);
         ...
         btn1 = (Button)rootView.findViewById(R.id.weekly);
        btn2 = (Button)rootView.findViewById(R.id.monthly);
...
//    }
    ...
    public void setTextColor(int textColor) {
        ...
        mTxtTitle.setTextColor(Color.parseColor("#000000"));
    }
    ...
    public void setPrimaryColor(int primaryColor) {
        ...
        mLayoutRoot.setBackgroundColor(Color.parseColor("#FFFFFF"));
    }
